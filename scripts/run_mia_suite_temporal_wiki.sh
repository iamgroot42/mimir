...
do
    for model in "pythia-160m-deduped" # "pythia-2.8b-deduped" "pythia-1.4b-deduped" "pythia-160m-deduped" "pythia-2.8b-deduped" "pythia-6.9b-deduped" #"pythia-12b-deduped"  
    do
        python run.py \
