...
if __name__ == '__main__':
    ...
    if neigh_config and neigh_config.random_fills and config.neighborhood_config and "t5" in config.neighborhood_config and config.neighborhood_config.model:
